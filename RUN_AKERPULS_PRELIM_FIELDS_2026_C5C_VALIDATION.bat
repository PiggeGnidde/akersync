...
set "OUT=C:\AkerSyncRepo\work\akerpuls_prelim_fields_2026_v0_c5c_validation"
...
if not exist "%RASTERS%\c5b_manifest.json" (
  echo FAIL: C5b manifest missing.
  exit /b 1
)

echo ========================================================================================
echo AkerPuls 2026 - STOPPUNKT C5C FROZEN THIRD-HOLDOUT VALIDATION - ZERO PU
echo ========================================================================================
py -3 -m unittest tests.test_akerpuls_prelim_fields_2026_c5c_contract -v
if errorlevel 1 exit /b 1
py -3 src\127_akerpuls_prelim_fields_2026_c5c_validation.py --pilot-dir "%PILOT%" --raster-dir "%RASTERS%" --output-dir "%OUT%"
exit /b %ERRORLEVEL%
