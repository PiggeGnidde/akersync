...
set "OUT=C:\AkerSyncRepo\work\akerpuls_prelim_fields_2026_v0_stopb0_selection"
...
echo ========================================================================================
echo AkerPuls 2026 - STOPPUNKT B0 COMPACT PILOT SELECTION - ZERO PU
echo ========================================================================================
py -3 src\111_akerpuls_prelim_fields_2026_stopb0_select.py --local-paths "%LOCAL_PATHS%" --output-dir "%OUT%"
exit /b %ERRORLEVEL%
