...
def patch_html(html: str, mapping: dict[str, str]) -> str:
    ...
    required = (
        ...
        "ÅkerNorm ej tillgänglig ännu", "Högre osäkerhet", "Svag skiftesjustering",
